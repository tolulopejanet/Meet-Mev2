    ...
    >
      <div className="mx-auto max-w-7xl space-y-10">
        <div className="text-center">
          ...
          {/* <h2 className="mt-4 text-5xl font-black text-white">Who I am</h2> */}
          <p className="mx-auto mt-4 max-w-4xl text-base leading-8 text-slate-300 sm:text-xl">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="rounded-[2rem] overflow-hidden border border-slate-800 bg-slate-900/80 shadow-glow">
